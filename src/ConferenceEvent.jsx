...
const ConferenceEvent = () => {
  ...
  const mealsItems = useSelector((state) => state.meals); // Added mealsItems selector
  ...
  // Generate Items for TotalCost component
  ...
  // Calculate total cost for sections
              ...
              <div className="meal_selection">
                {mealsItems.map((item, index) => (
                  <div className="meal_item" key={index}>
                    ...
                    />
                    <label htmlFor={`meal_${index}`}>{item.name} - ${item.cost}</label>
                  </div>
                ))}
              </div>
